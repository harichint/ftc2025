...
// import com.qualcomm.robotcore.hardware.Servo; // No longer needed
 ...
 */
@TeleOp(name = "Intake TeleOp", group = "Sensor")
public class Intake extends OpMode {

    // --- Hardware Members ---
    private DcMotor intakeRoller;   // A standard DC motor, likely for a spinning front roller.
